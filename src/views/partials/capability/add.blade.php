...
@endif
{{Form::open(['route'=>['capability.create'],'class'=>'form form-horizontal','style'=>'margin-top:50px'])}}
<div class="form-group">
    ...
    <div class="col-sm-8">
        ...
        {{ Form::text('capability',Input::old('capability'),['class'=>'form-control','placeholder'=>'format: resource_action|manage_resource etc']) }}
    </div>
</div>
<div class="form-group">
...
<div class="text-center">
    {{Form::submit('Create Capability',['class'=>'btn btn-default'])}}
</div>
{{Form::close()}}